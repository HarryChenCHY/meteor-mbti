...
import { SHOP_ITEMS, CAT_COLORS, STAGE_SKINS, STAGES, getStage, getStageProgress, STAGE_THRESHOLDS } from '../constants';
import MeteorOrb from '../components/MeteorOrb';
import PageWrapper from '../components/PageWrapper';
import { SectionTitle } from '../components/SharedUI';

export default function ShopPage({ onNavigate, energy, onSpendEnergy }) {
