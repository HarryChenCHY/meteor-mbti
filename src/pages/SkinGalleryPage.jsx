import { STAGE_SKINS, STAGES, STAGE_THRESHOLDS, getStage, getStageProgress } from '../constants';
import MeteorOrb from '../components/MeteorOrb';
import PageWrapper from '../components/PageWrapper';
import { SectionTitle } from '../components/SharedUI';

export default function SkinGalleryPage({ onNavigate, energy }) {
